...
function getConfig(uuid, host, proxyAddresses) { const address = Array.isArray(proxyAddresses) ? proxyAddresses[0] : proxyAddresses; return `
    <html>
        <body>
...
async function handleDefaultPath(url, request) { return new Response("Not Found", { status: 404 }); }
